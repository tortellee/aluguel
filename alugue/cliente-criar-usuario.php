...
<br><br>
<u><h3>CRIAR USUÁRIO</h3></u>
</div>
<br>
<form name="nova-categoria" method="post" action="cliente-criar-usuarios-post.php">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
                <br>
                <input type="hidden" maxlength="30" class="form-control" placeholder="tipo:" name="tipo" value="usuario" required>
